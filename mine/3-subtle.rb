...
##########################################################################
# W-period, W-comma: Change to next or prev view
##########################################################################
...
##########################################################################
# W-$mousebutton: Move and resize windows
##########################################################################
# Move current window
...
# Raise window
grab "W-i", :WindowRaise

# Lower window
grab "W-u", :WindowLower
...
##########################################################################
grab "W-C-c", "chromium"
grab "W-C-e", "firefox --class ffdev --no-remote -P dev"
grab "W-C-f", "firefox --class ffdefault -P default"
grab "W-C-l", "xautolock -locknow"
grab "W-C-o", "firefox --class fftor --no-remote -P Tor"
grab "W-C-r", "urxvt -e vitag"
...
##########################################################################
# W-Return $char, W-S-Return: Terminals
##########################################################################
grab "W-S-Return", "urxvt"
grab "W-Return s", "urxvt -name stickyterm"
grab "W-Return d", "urxvt -name devterm"
grab "W-Return m", "urxvt -name mailterm"
grab "W-Return j", "urxvt -name mcabber"
grab "W-Return t", "urxvt -name turses"

##########################################################################
# W-$cursor_key, W-S-$cursor_key
##########################################################################
...
grab "W-S-Left",  :WindowResizeLeft
grab "W-S-Right", :WindowResizeRight
grab "W-S-Up",    :WindowResizeUp
grab "W-S-Down",  :WindowResizeDown
...
tag "browser" do 
  match "uzbl|opera|chromium|dillo"
  match :class => "ffdefault|fftor"
end
